...
public interface CategoryMappingHelper {
  ...
  public static CategoryDto map(final Category category) {
    ...
    final var parentCategory =
        Optional.ofNullable(category.getParentCategory()).orElseGet(() -> new Category());
  ...
  public static Category map(final CategoryDto categoryDto) {
    ...
    final var parentCategoryDto =
        Optional.ofNullable(categoryDto.getParentCategoryDto()).orElseGet(() -> new CategoryDto());
