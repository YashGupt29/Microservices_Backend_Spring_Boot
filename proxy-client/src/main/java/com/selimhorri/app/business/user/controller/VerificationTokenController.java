...
public class VerificationTokenController {
  ...
  public ResponseEntity<VerificationTokenDto> findById(
    ...
    return ResponseEntity.ok(
        this.verificationTokenClientService.findById(verificationTokenId).getBody());
  }
  ...
  public ResponseEntity<VerificationTokenDto> save(
    ...
    return ResponseEntity.ok(
        this.verificationTokenClientService.save(verificationTokenDto).getBody());
  }
  ...
  public ResponseEntity<VerificationTokenDto> update(
      @RequestBody final VerificationTokenDto verificationTokenDto) {
    return ResponseEntity.ok(
        this.verificationTokenClientService.update(verificationTokenDto).getBody());
  }
  ...
  public ResponseEntity<Boolean> deleteById(
      @PathVariable("verificationTokenId") final String verificationTokenId) {
    return ResponseEntity.ok(
        this.verificationTokenClientService.deleteById(verificationTokenId).getBody());
  }
}
