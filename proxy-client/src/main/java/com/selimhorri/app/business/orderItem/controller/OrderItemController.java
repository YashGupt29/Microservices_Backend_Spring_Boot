...
public class OrderItemController {
  ...
  public ResponseEntity<OrderItemDto> findById(
    ...
    return ResponseEntity.ok(
        this.orderItemClientService
            .findById(new OrderItemId(Integer.parseInt(productId), Integer.parseInt(orderId)))
            .getBody());
  }
  ...
  public ResponseEntity<Boolean> deleteById(
      ...
      @PathVariable("productId") final String productId) {
    this.orderItemClientService
        .deleteById(new OrderItemId(Integer.parseInt(orderId), Integer.parseInt(productId)))
        .getBody();
