...
public class VerificationTokenServiceImpl implements VerificationTokenService {
  ...
  public List<VerificationTokenDto> findAll() {
    ...
    return this.verificationTokenRepository.findAll().stream()
        ...
        .orElseThrow(
            () ->
                new VerificationTokenNotFoundException(
                    String.format(
                        "#### VerificationToken with id: %d not found! ####",
                        verificationTokenId)));
  }
  ...
  public VerificationTokenDto save(final VerificationTokenDto verificationTokenDto) {
    ...
    return VerificationTokenMappingHelper.map(
        this.verificationTokenRepository.save(
            VerificationTokenMappingHelper.map(verificationTokenDto)));
  }
  ...
  @Override
  public VerificationTokenDto update(
      final Integer verificationTokenId, final VerificationTokenDto verificationTokenDto) {
    log.info(
        "*** VerificationTokenDto, service; update verificationToken with verificationTokenId *");
    return VerificationTokenMappingHelper.map(
        this.verificationTokenRepository.save(
