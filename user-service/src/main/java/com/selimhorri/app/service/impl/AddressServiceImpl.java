...
public class AddressServiceImpl implements AddressService {
  ...
  public AddressDto save(final AddressDto addressDto) {
    ...
    return AddressMappingHelper.map(
        this.addressRepository.save(AddressMappingHelper.map(addressDto)));
  }
  ...
  public AddressDto update(final Integer addressId, final AddressDto addressDto) {
    ...
    return AddressMappingHelper.map(
        this.addressRepository.save(AddressMappingHelper.map(this.findById(addressId))));
  }
